...
---
## A deep dive into the Brown’s big offseason right tackle acquisition
...
We began by examining Conklin's seemingly perfect fit within Stefanski's zone-heavy offensive scheme, partially due to his prowess as a run blocker but also due to his experience within a similar offense during his time in Tennessee. Next, we showed that, despite being an average athlete compared to other NFL tackles, Conklin is able to overcome his limitations with top notch fundaments – from hand placement in pass protection to attack angles when running the outside zone. Lastly, we wrapped things up with by delving into Conklin’s team-friendly contract, which is largely due to the simple fact that he plays on the right side of the offensive line.
